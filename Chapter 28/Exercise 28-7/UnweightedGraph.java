 ...
 * Date: 01 Mar 2023
 * 
 * This code has been modified to include the getACycle method.
 */
...
public class UnweightedGraph<V> implements Graph<V> {
	...
	public List<Integer> getACycle(){
		//Create arrays for storing vertices, parents, and if visited
		...
		while(vertices.size() > 0) {
			int v = allVertices.get(allVertices.size()-1);
			Stack<Integer> stack = new Stack<Integer>();
			stack.push(v);
			visited[v]= true;

			//System.out.println("Size: "+ allVertices.size());
