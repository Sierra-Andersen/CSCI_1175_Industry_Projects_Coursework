 ...
 *Date: 16 Mar 2023
 *
 * This program is a demo of a Tab Pane. The Tab Pane can change placement and the tabs show different shapes.
 */
...
public class TabPaneDemo extends Application {   
	...
	public void start(Stage primaryStage) {   
		...
		ToggleGroup alignmentTG = new ToggleGroup();

		rbTop.setToggleGroup(alignmentTG);
		rbLeft.setToggleGroup(alignmentTG);
		rbBottom.setToggleGroup(alignmentTG);
		rbRight.setToggleGroup(alignmentTG);

		buttonHB.getChildren().addAll(rbTop, rbLeft, rbBottom, rbRight);
		...
		vBox.getChildren().addAll(tabPane, buttonHB);
